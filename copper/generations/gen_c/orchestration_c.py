...
class ArrangeC(machines.FragmentLine, machines.PitchedLine):
...
class OrchestrationC(staves.CopperMusic, gen_c.GenC):
...
bubbles.illustrate_me(__file__, 
    lambda: staves.CopperScore( OrchestrationC(), title="Copper: C", show_short_score=True, hide_empty=True).get_lilypond_file()
    )
