...
class ArrangeB(machines.FragmentLine, machines.PitchedLine):
...
class OrchestrationB(staves.CopperMusic, gen_b.GenB): # TO DO... maybe these shouldn't inherit from the gens????
