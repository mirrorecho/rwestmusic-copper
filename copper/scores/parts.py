...
def wind_parts():
    ...
    bubbles.illustrate_me_file("Picc", __file__, 
    ...
    bubbles.illustrate_me_file("Flute1", __file__, 
    ...
    bubbles.illustrate_me_file("Flute2", __file__, 
    ...
    # bubbles.illustrate_me_file("Oboes", __file__, 
    ...
    #     clarinet1.transpose = 2
    #     clarinet2.transpose = 2
    # bubbles.illustrate_me_file("Clarinets", __file__, 
    ...
    # bubbles.illustrate_me_file("Bassoons", __file__, 
...
def brass_parts():
    ...
    #     horn1.transpose = 7
    #     horn2.transpose = 7
    # bubbles.illustrate_me_file("Horns", __file__, 
    ...
    bubbles.illustrate_me_file("Trumpets", __file__, 
    ...
    # bubbles.illustrate_me_file("Trombones", __file__, 
    ...
    # bubbles.illustrate_me_file("Tuba", __file__, 
...
# def hit_parts():
    ...
    # bubbles.illustrate_me_file("Timpani", __file__, 
    ...
    # bubbles.illustrate_me_file("Percussion", __file__, 
    ...
    # bubbles.illustrate_me_file("Harp", __file__, 
    ...
    # bubbles.illustrate_me_file("Piano", __file__, 
...
#     bubbles.illustrate_me_file("ViolinI", __file__, 
...
#     bubbles.illustrate_me_file("ViolinII", __file__, 
...
#     bubbles.illustrate_me_file("Viola", __file__, 
...
#         )
    ...
    # bubbles.illustrate_me_file("Cello", __file__, 
    ...
    # bubbles.illustrate_me_file("Bass", __file__, 
